...
#Mi función calcula correctamente si dos vectores son ortogonales, los vectores que elegiste cumplen la condición de ortogonalidad (producto punto = 0) por eso se imprime "vectores ortogonales correctamente"; si elijieramos otro "x" y otro "y" apareceria que algo salio mal.